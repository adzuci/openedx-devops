...
#---------------------------------------------------------
S3_BUCKET="prod-usa-live-storage"
MONGODB_HOST="mongodb.schoolofrock.edu:27017"
...
mongorestore -d prod_live_edx ~/backups/mongodb/mongo-dump-${BACKUP_KEY}/edxapp --host $MONGODB_HOST
